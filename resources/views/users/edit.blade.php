  ...
  <div class="max-w-xl mx-auto px-4 pt-4 pb-8 h-[calc(100vh-100px)]">
    <div class="bg-white shadow rounded-lg h-full flex flex-col overflow-hidden">
      ...
      <div class="px-6 py-2 border-b">
        <h1 class="text-xl font-bold">✏️ Edit User</h1>
      </div>
      ...
      <div class="px-6 py-2 overflow-y-auto flex-1">
        <form action="{{ route('users.update', $user->id) }}" method="POST" class="space-y-5">
          ...
          <div>
            <label for="password" class="block text-sm font-medium">Password Baru <span class="text-sm text-gray-400">(Opsional)</span></label>
