    ...
    <div class="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 min-h-screen">
      <div class="bg-white shadow-lg rounded-xl overflow-hidden">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-6 py-5 border-b">
          <h2 class="text-2xl font-semibold text-gray-800">✏️ Edit Produk</h2>
        ...
        <!-- Form -->
        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="px-6 py-4 space-y-5">
          @csrf
          @method('PUT')
